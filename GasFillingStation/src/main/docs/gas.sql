...
INSERT INTO `menu` VALUES (1,'用户管理','用户管理','/users'),(2,'子站管理','子站管理','/substation'),(3,'业务处理','业务处理','/business'),(4,'数据查询','数据查询','/data'),(5,'报表生成','报表生成','/report'),(6,'系统设置','系统设置','/setting');
...
-- Dump completed on 2015-12-06 16:44:39
